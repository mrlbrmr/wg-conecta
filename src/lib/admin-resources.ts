  ...
  },
  {
    ...
    fields: [
      ...
      { key: "icon", label: "Ícone", type: "icon" },
      {
        ...
        label: "Link",
        type: "text",
        help: "Página do portal (/gente-gestao/beneficios) ou site externo (https://…). Deixe vazio se o atalho abrir o conteúdo abaixo.",
      },
      {
        key: "content",
        label: "Conteúdo / tutorial",
        type: "richtext",
        help: "Opcional. Com conteúdo, o atalho abre uma página do portal com o texto e os vídeos.",
      },
      { key: "category", label: "Categoria", type: "text" },
